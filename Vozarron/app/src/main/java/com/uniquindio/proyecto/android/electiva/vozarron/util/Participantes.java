...
public class Participantes {
    ...
    public Participantes() {
        ...
        Participante participante4 = new Participante("Jose", 23, new Entrenador(), "Docente", "foto", "video");
        ...
        Participante participante6 = new Participante("Mario", 23, new Entrenador(), "Docente", "foto", "video");
        ...
        Participante participante10 = new Participante("Juana", 23, new Entrenador(), "Docente", "foto", "video");
